...
QT_MOC_LITERAL(1, 17, 9), // "onValider"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "FormulaireWindow\0onValider\0"
};
...
void FormulaireWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FormulaireWindow *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject FormulaireWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_FormulaireWindow.data,
    qt_meta_data_FormulaireWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
